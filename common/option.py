...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--stack', type=int, default=0, help='number of DSLUT serial stacks')
        ...
        parser.add_argument('--use_shift', action='store_true', help='Use spatial shift or not')
        parser.add_argument('--msb_base', type=int, default=6)
        parser.add_argument('--cnum', type=int, default=16)
        parser.add_argument('--fl', type=int, default=-1)
...
class TrainOptions(BaseOptions):
    def initialize(self, parser):
        ...
        parser.add_argument('--alpha_weight', type=float, default=1e-4)
        parser.add_argument('--totalT', type=int, default=1)
        parser.add_argument('--sigma', type=int, default=15)
        parser.add_argument('--qf', type=int, default=10)
